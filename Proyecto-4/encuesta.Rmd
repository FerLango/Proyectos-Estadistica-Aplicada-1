...
Haciendo el cálculo obtenemos que nuestra población total estimada de hombres es de `r 126014024/nrow(data_poblacion) * sexo_muestra$n[1]`. 
...
Haciendo el cálculo obtenemos que nuestra población total estimada de mujeres es de `r 126014024/nrow(data_poblacion) * sexo_muestra$n[2]`.
